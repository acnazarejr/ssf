...
******/
ModKalmanTracking::ModKalmanTracking(string modID) :  SSFUserModule(modID) {
...
ModKalmanTracking::~ModKalmanTracking(void){
}
...
SSFMethod *ModKalmanTracking::Instantiate(string modID) {
...
//        setIdentity(KF.measurementNoiseCov, Scalar::all(0.02)); // this is inverse to the ModKalmanTracking speed
//        setIdentity(KF.errorCovPost, Scalar::all(1));
...
void ModKalmanTracking::Execute() {
	...
	for (int i = 0; i < samples.size(); i++) {
		...
		setIdentity(KF.measurementMatrix,Scalar(1));
		setIdentity(KF.processNoiseCov, Scalar::all(.00005));
		setIdentity(KF.measurementNoiseCov, Scalar::all(0.02)); // this is inverse to the ModKalmanTracking speed
		setIdentity(KF.errorCovPost, Scalar::all(1));
